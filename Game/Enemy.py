...
class Enemy2(Enemy):
    def __init__(self):
        super().__init__(ENEMY_2, dim=(.1, .1), velocity=.325, img="res/enemy2.png")
        self.color = (0, 0, 255)


class Enemy3(Enemy):
    def __init__(self):
        super().__init__(ENEMY_3, dim=(.1, .1), velocity=.433, img="res/enemy3.png")
        self.color = (0, 255, 0)


class Enemy4(Enemy):
    def __init__(self):
        super().__init__(ENEMY_4, dim=(.1, .1), velocity=.6, img="res/enemy4.png")
        self.color = (255, 255, 0)


class Enemy5(Enemy):
    def __init__(self):
        super().__init__(ENEMY_5, dim=(.1, .1), velocity=1, img="res/enemy5.png")
